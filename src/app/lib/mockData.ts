...
export const mockItems: Item[] = [
  ...
  },
  {
    ...
    description: "Stewart's Calculus, 8th Edition. Has my name and notes inside. Lost in the Mathematics building.",
    category: "books",
    status: "lost",
  ...
  },
  {
    ...
    description: "Found a blue Hydro Flask water bottle near the gym. Has some stickers on it.",
    category: "other",
    status: "found",
  ...
  },
  {
    id: "5",
    title: "AirPods Pro",
    description: "Lost my AirPods Pro with charging case. Last seen in the Computer Science lab.",
    category: "electronics",
    status: "lost",
  ...
  },
  {
    ...
    description: "Found a black North Face backpack in the parking lot. Contains some notebooks and a laptop.",
    category: "other",
    status: "found",
  ...
  },
  {
    id: "8",
    title: "Gray Hoodie",
    description: "Found a gray Champion hoodie in the lecture hall. Size M.",
    category: "clothing",
    status: "found",
    location: "Lecture Hall A - Row 5",
    date: "2026-04-19",
